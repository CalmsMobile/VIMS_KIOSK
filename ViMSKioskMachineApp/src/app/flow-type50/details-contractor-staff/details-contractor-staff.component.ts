...
@Component({
  selector: 'app-details-contractor-staff',
  templateUrl: './details-contractor-staff.component.html',
  styleUrls: ['./details-contractor-staff.component.scss']
})
export class DetailsContractorStaffComponent implements OnInit {
