...
export class AppointmentDetailComponent implements OnInit {
  ...
  teamsCallToHost = false;
  disableCallToHost = true;
  ...
  _initUpdateScanDataValues() {
    ...
    if ((this.docType == "PASSPORT" || this.docType == "SING_NRICrDRIV" || this.docType == "MYCARD")
      ...
      if (this.KIOSK_PROPERTIES.COMMON_CONFIG.AppointmentQuickCheckIn && this.KIOSK_PROPERTIES.COMMON_CONFIG.AppointmentQuickCheckIn.enable) {
        ...
        if (this.KIOSK_PROPERTIES.commonsetup.Enable_PDPA && this.aptmDetails.id != '') {
  ...
  showIdVerificationAlert() {
    const dialogRef = this.dialog.open(DialogAppSessionTimeOutDialog, {
      ...
      data: {
        "title": '',
        "subTile": this.KIOSK_PROPERTIES_LOCAL.idVerificationFailedAlertMsg,
        "enbCancel": true,
        "oktext": 'Retry',
        "canceltext": 'Go Home'
      },
  ...
  calculateNumberofInputs() {
    ...
    if (this.KIOSK_PROPERTIES.COMMON_CONFIG.PassNo && this.KIOSK_PROPERTIES.COMMON_CONFIG.PassNo.Show) {
      this.NUMBER_OF_INPUTS++;
  ...
  _updateKioskSettings() {
    ...
    if (setngs != undefined && setngs != "") {
      ...
      if (this.KIOSK_PROPERTIES_LOCAL) {
        ...
        this.teamsCallToHost = this.KIOSK_PROPERTIES_LOCAL.teamsCallToHost;
      }
